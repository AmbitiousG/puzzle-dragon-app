...
const { getMonsterImage, getMonsterAttrId, getMonsterTypeId, getMonsterAwokenSkillId, getMonsterActiveSkillId, getMonsterId } = require('./api');
  ...
  async getPlainData() {
    ...
    let monsterObj = {
      ...
      ...await getMonsterImage({
        ...
        avatarUrl: plainObj.avatarUrl,
        charactorImageUrl: plainObj.charactorImageUrl
      }),
